...
- `YANDEX_GEOCODE_API_KEY` - это Ваш секретный ключ для доступа к сервису geocode от Яндекса [инструкция](https://yandex.ru/dev/geocode/doc/ru/)


## Просмотр логов

В проекте установлена система логгирования [rollbar](https://rollbar.com/)

Для его настройки, вам нужен токен приложения для вашего пользователя, получите его зарегистрировавшись на сайте и добавьте в пеерменную окружения `ROLLBAR_TOKEN`, затем укажите какая у вас версия проекта - development или production и добавьте ее в переменную `APP_VERSION`


## Настройка Базы Данных

В проекте осуществляется работа с БД Postgres. Для настройки БД используют библиотеку [dj-database-url](https://github.com/jazzband/dj-database-url). Используйте одну единственную переменную окружения для базы данных [DB_URL](https://gist.github.com/jbothma/8a9a30399c2091d89763bff0a1952da4)
